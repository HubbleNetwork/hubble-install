...
// PrintCompletionBanner prints the success completion banner and returns whether user wants to install CLI
func PrintCompletionBanner(duration time.Duration, orgID, apiToken, deviceName string, debugMode bool) bool {
	green.Print(`
╔═══════════════════════════════════════════════════════════╗
...
`)
	...
	installCLI := PromptYesNo("Now that you have your first device, would you like to install the hubbledemo CLI?", true)

	return installCLI
}

// PrintCLIInstalledInstructions prints instructions after CLI installation
func PrintCLIInstalledInstructions(orgID string) {
	fmt.Println()
	green.Println("✓ hubbledemo CLI installed!")
	fmt.Println()
	cyan.Println("To flash more devices:")
	fmt.Println()
	fmt.Print("  Set credentials as environment variables:\n")
	fmt.Printf("     ")
	...
	fmt.Println()
	fmt.Print("  View available commands:\n     ")
	bold.Println("hubbledemo --help")
	fmt.Println()
	yellow.Println("Need help? Visit https://hubble.com/support/")
}

// PrintCLISkippedInstructions prints instructions when CLI installation is skipped
func PrintCLISkippedInstructions(orgID string) {
	fmt.Println()
	cyan.Println("Script completed successfully.")
	yellow.Println("Need help? Visit https://hubble.com/support/")
}
